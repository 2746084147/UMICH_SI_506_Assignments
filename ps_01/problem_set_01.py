...
cottage_inn = cottage_inn.upper()
print(cottage_inn)

madras_masala = "Madras Masala"
madras_masala = madras_masala.upper()
print(madras_masala)
...
jerk_pit_all_upper = jerk_pit.lower()
...
total_bill = total_price * 0.15 + total_price * 0.06 + total_price
...
print(f"Someone said '{updated_comment}' on\nYelp for the restaurant {jerk_pit_all_upper}.")
...
def calc_pct(num_dish, total_orders):
    pct = (num_dish / total_orders) * 100
    return round(pct, 2)
...
# TODO Call print()
print(jerk_pork_pct, coconut_shrimp_pct, jerk_wings_pct, caesar_salad_pct, jerk_tofu_pct, oxtail_pct)
